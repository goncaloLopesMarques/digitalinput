   ...
   <section class="card wow fadeIn radial-purple-gradient intro" style="background:radial-gradient( circle at top, #513057, #191f2c ) ;visibility: visible; animation-name: fadeIn;">
      <!-- Content -->
      <div class="row text-white" style="height:calc(100vh - 45px)"><!-- style="background-image: url('/images/Programmer-Developer-Wallpaper.jpg');" -->
         ...
         <div class="col-md-12 my-vertical-align" style="height:calc(75vh - 45px)">

            <div>
               <h2 class="col-md-12 h4-responsive">Especialistas Webdesign, Publicidade e Design Gráfico. Conheça as vantagens de ser nosso parceiro!</h2>
               <h3 class="col-md-12 h4-responsive">Esteja presente na internet, melhore os seus resultados online.</h3>
      ...
      <div class="row">
          ...
          <div class="servicos-home col-lg-4 col-md-6 col-xs-12">
            <div class="my card col-md-12 cloudy-knoxville-gradient">
              <div class="my card-body">
                  ...
                  <p class="py-1">- Criação de sites para empresas</p> 
                  <p class="py-1">- Site profissional modernoz</p>
          ...
          <div class="servicos-home col-lg-4 col-md-6 col-xs-12">
            <div class="my card col-md-12 cloudy-knoxville-gradient">
              ...
              <div class="card-footer">
                  <small class="text-muted">Criar Loja Online | Site de Vendas | Loja Virtual</small>
              </div>
           </div>
          </div>
...
<h3 class="h1-responsive ml-5 mt-5 pl-5 pt-5">
               <p class="font-weight-bold" style="    text-decoration: overline;
    text-decoration-color: #212529;">Trabalhos Recentes</p>
            </h3>
      ...
      <div class="wow fadeIn my-5" style="visibility: visible; animation-name: fadeIn;">
        ...
        <!--  <h2 class="h1 text-center mb-5" style="font-size: 1.5rem;">A nossa área de cliente permite lhe gerir os seus dados pessoais</h2>
         ...
         <div class="row">
            ...
            o que fazemos com eles, permitimos tambem que posos pedir para ser excluido ou removido sem burocracias.
            </div>
         </div>
      </div>
      <!-- Heading & Description -->
